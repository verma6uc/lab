...
public class UserSession {
    ...
    public void setLastActivityAt(ZonedDateTime lastActivityAt) { this.lastActivityAt = lastActivityAt; }
    ...
    public Boolean getIsSecureConnection() { return isSecureConnection; }
    public void setIsSecureConnection(Boolean isSecureConnection) { this.isSecureConnection = isSecureConnection; }
